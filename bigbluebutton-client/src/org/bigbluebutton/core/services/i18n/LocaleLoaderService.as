...
* 
*/
package org.bigbluebutton.core.services.i18n
{
	...
	public class LocaleLoaderService implements ILocaleService {
		private static var instance:LocaleLoaderService = null;
		...
		public static function getInstance():LocaleLoaderService {
			if (instance == null) {
				LogUtil.debug("Setting up supported locales.");
				instance = new LocaleLoaderService(new SingletonEnforcer);
			} 
			return instance;
        }
